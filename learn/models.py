...
class Song(models.Model):
    ...
    image = models.ImageField(upload_to='learn_songs_images/', blank=True, null=True)
    youtube_url = models.URLField(blank=True)
    audio = models.FileField(upload_to='learn_songs/', blank=True, null=True)
...
class DancePose(models.Model):
    ...
    dance_name = models.CharField(max_length=20, choices=DANCE_CHOICES, default='odissi')
    pose_name = models.CharField(max_length=150)
    image = models.ImageField(upload_to='learn_dance/', blank=True, null=True)
...
class LanguagePhrase(models.Model):
    ...
    audio = models.FileField(upload_to='learn_language/', blank=True, null=True)
